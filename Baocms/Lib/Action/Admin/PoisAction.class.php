...
class PoisAction extends CommonAction {
    ...
    private $create_fields = array('name', 'shop_id' ,'type', 'lat' , 'lng' , 'telephone' , 'address', 'tag', 'is_lock', 'orderby' ,'status', 'create_time');
    private $edit_fields = array('name', 'shop_id' , 'type', 'lat' , 'lng' , 'telephone' , 'address', 'tag', 'is_lock', 'orderby' ,'status', 'create_time');
